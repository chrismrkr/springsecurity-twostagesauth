...
* The original package name 'com.example.springsecurity-multiauth' is invalid and this project uses 'com.example.springsecuritymultiauth' instead.
...
* [Spring Data Redis (Access+Driver)](https://docs.spring.io/spring-boot/docs/3.1.11/reference/htmlsingle/index.html#data.nosql.redis)
